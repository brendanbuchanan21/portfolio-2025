...
export default function Footer() {
    ...
    return (
        <>
        <div className="border-t-1 border-border bg-black pt-8 pb-4 px-5 sm:px-20 xl:px-52 flex flex-row justify-between">
        ...
        <div className=" pt-8 pb-4 px-5 sm:px-20 xl:px-52 flex flex-row justify-between">
